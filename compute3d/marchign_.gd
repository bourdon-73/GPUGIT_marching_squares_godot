...
func init_compute():
	...
	# Load compute shader
	var shader_file : RDShaderFile = load("res://compute3d/#[compute].glsl")
	...
	# Create lut buffer
	var lut = load_lut("res://compute3d/MarchingCubesLUT.txt")
	...
	var buffers = [triangle_uniform, params_uniform, counter_uniform, lut_uniform, matrix_uniform]
